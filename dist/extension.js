...
function activate(context) {
    ...
    fs.readFile(configFile, 'utf8', (err, data) => {
        ...
        axios_1.default.get(url + dataObj.id_token, axiosConfig)
            ...
            context.subscriptions.push(vscode.commands.registerCommand('101obex-api-extension.ask', () => vscode.window.showInputBox({ prompt: 'What do you want to do?' })
                .then((value) => provider.escriberespuesta(value))), vscode.commands.registerCommand('101obex-api-extension.explain', () => commandHandler('promptPrefix.explain')), vscode.commands.registerCommand('101obex-api-extension.refactor', () => commandHandler('promptPrefix.refactor')), vscode.commands.registerCommand('101obex-api-extension.optimize', () => commandHandler('promptPrefix.optimize')), vscode.commands.registerCommand('101obex-api-extension.findProblems', () => commandHandler('promptPrefix.findProblems')), vscode.commands.registerCommand('101obex-api-extension.documentation', () => commandHandler('promptPrefix.documentation')), vscode.commands.registerCommand('101obex-api-extension.resetConversation', () => provider.resetConversation()));
        ...
        if (!consultando) {
            ...
            if (selection && selectedText) {
                ...
                if (this._settings.selectedInsideCodeblock) {
                    searchPrompt = `${prompt}\n\`\`\`${languageId}\n${selectedText}\n\`\`\``;
                    var resulquery = (__webpack_require__(42).escape)(searchPrompt);
...
/////
class TreeDataProviderAPIs {
    constructor(response) {
        this._onDidChangeTreeData = new vscode.EventEmitter();
        this.onDidChangeTreeData = this._onDidChangeTreeData.event;
        var responses = [];
        response.data.data[0].apis.forEach((element) => {
            var subresponses = [];
...
class TreeDataProviderProjects {
    constructor(response, control) {
        this._onDidChangeTreeData = new vscode.EventEmitter();
        this.onDidChangeTreeData = this._onDidChangeTreeData.event;
        var responses = [];
...
class TreeDataProviderOrganization {
    constructor(response) {
        this._onDidChangeTreeData = new vscode.EventEmitter();
        this.onDidChangeTreeData = this._onDidChangeTreeData.event;
        var responses = [];
...
function projects(context, response, control) {
    var tt = {};
    if (control) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('101obex-api-extension.refreshEntry-projects', () => projectsTreeProvider.refresh()));
}
function teams(context, response, nuevo) {
    ...
    if (nuevo) {
        context.subscriptions.push(vscode.commands.registerCommand('101obex-api-extension.refreshEntry-teams', () => teamsTreeProvider.refresh()));
    }
}
function organizations(context, response, nuevo) {
    ...
    if (nuevo) {
        context.subscriptions.push(vscode.commands.registerCommand('101obex-api-extension.refreshEntry-organizations', () => organizationsTreeProvider.refresh()));
    }
}
