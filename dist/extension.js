...
var TokenData;
function getWebviewContent(url, headers, api_parameters, api_values) {
...
function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider('101obex-api-extension-api-tester.myPanel', thisProvider));
    ...
    //  );
    //}
    context.subscriptions.push(vscode.commands.registerCommand('101obex-api-extension-api-tester.TestSelected', () => {
    ...
    if (ACCESS) {
        ...
        fs.readFile(configFile, 'utf8', (err, data) => {
            ...
            axios_1.default.get(url + dataObj.id_token, axiosConfig)
                ...
                try {
                    context.subscriptions.push(vscode.commands.registerCommand('101obex-api-extension-api-tester.SayHi', () => thisProvider.sayHi('https://docking.101obex.mooo.com/ws/util.py/paises')));
                }
                catch { }
    ...
    constructor(response) {
        ...
        res.data.data[0].low_code.forEach((element) => {
            ...
            element.apis.forEach((subelement) => {
                ...
                subresponses8.push(new TreeItem(`${subelement["name"]}`, ttt, 'config', `${element.model}|${subelement.name}`));
            });
