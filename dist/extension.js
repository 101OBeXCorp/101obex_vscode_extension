...
function apis(context, response, contexto) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('101obex-api-doc-extension.refreshEntry-apis', () => apisTreeProvider.refresh()));
}
...
function registerPythonCompletion(context, response) {
