...
class Steps {
    ...
    static getString(name,posX, posY, chars, targetVariable) {
		/*return createTaskStep('setNumber', name, {
			targetVarName,
			value,
			properties: {
    ...
    static deleteField(name,posX, posY) {
		/*return createTaskStep('setNumber', name, {
			targetVarName,
			value,
			properties: {
	...
	static setNumber(name,posX, posY, sourceVariable) {
		/*return createTaskStep('setNumber', name, {
			targetVarName,
			value,
			properties: {
	...
	static assignVar(name, posX, posY, storeVariable) {
        /*
